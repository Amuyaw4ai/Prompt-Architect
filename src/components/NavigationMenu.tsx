  ...
  return (
    <div className="flex items-center gap-2">
      <button
        ...
        className={cn(
          "flex items-center gap-2 px-4 py-2 border rounded-xl transition-all shadow-sm cursor-pointer",
          currentView === 'home'
            ? "bg-emerald-50 dark:bg-emerald-900/30 border-emerald-200 dark:border-emerald-800 text-emerald-600 dark:text-emerald-400 font-bold"
            : "bg-stone-100/80 dark:bg-slate-800/80 border-stone-200 dark:border-slate-700 hover:bg-stone-200 dark:hover:bg-slate-700 text-stone-700 dark:text-slate-200 font-semibold"
        )}
      >
        <HomeIcon size={16} />
      ...
      <div className="relative" ref={dropdownRef}>
        ...
        >
          ...
          <ChevronDown size={14} className={cn("transition-transform ml-1", isOpen ? "rotate-180" : "")} />
        </button>
